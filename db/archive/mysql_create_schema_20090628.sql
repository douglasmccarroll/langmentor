...
CREATE TABLE learning_feedback (
  learning_feedback_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE learning_mode (
  learning_mode_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE uber_module (
  uber_module_id MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT,
  native_language_id SMALLINT UNSIGNED NOT NULL,
  target_language_id SMALLINT UNSIGNED NOT NULL,
  en_us_uber_module_name VARCHAR (100) NOT NULL,
  most_recent_module_version_creation_date_time DATETIME NOT NULL,
...
CREATE TABLE module_version (
  module_version_id MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT,
  published_module_version_id MEDIUMINT UNSIGNED,
  module_version_total_audio_duration MEDIUMINT UNSIGNED NOT NULL,
  ...
  premium BOOL,
  module_version_creation_date_time DATETIME NOT NULL,
...
CREATE TABLE chunk (
  chunk_id MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  uber_module_creation_date_time DATETIME NOT NULL,
  order_level TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE module_version_consumption (
  module_version_consumption_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE module_version_contribution (
  module_version_contribution_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
...
CREATE TABLE quality_feedback (
  quality_feedback_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
  en_us_name VARCHAR(100) NOT NULL,
...
CREATE TABLE user_learning_feedback (
  user_learning_feedback_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  module_version_total_audio_duration MEDIUMINT UNSIGNED NOT NULL,
...
CREATE TABLE user_quality_feedback (
  user_quality_feedback_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  module_version_total_audio_duration MEDIUMINT UNSIGNED NOT NULL,
  date_time DATETIME NOT NULL,
...
CREATE TABLE user_module_version_link (
  user_module_version_link_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
