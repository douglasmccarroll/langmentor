...
CREATE TABLE category (
  category_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
  en_us_name VARCHAR(45) NOT NULL,
  PRIMARY KEY (category_id)
) @engine@ @default.charset@;

CREATE TABLE language (
  language_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
...
CREATE TABLE learning_feedback (
  learning_feedback_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
...
CREATE TABLE learning_mode (
  learning_mode_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
...
CREATE TABLE level (
  level_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
  en_us_name VARCHAR(50) NOT NULL,
  order_level TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE uber_module (
  uber_module_id MEDIUMINT UNSIGNED NOT NULL @auto.increment@,
  native_language_id SMALLINT UNSIGNED NOT NULL,
  target_language_id SMALLINT UNSIGNED NOT NULL,
  most_recent_module_version_creation_date_time @datetime.data.type@ NOT NULL,
...
CREATE TABLE module_version (
  module_version_id MEDIUMINT UNSIGNED NOT NULL @auto.increment@,
  ...
  premium BOOL,
  module_version_creation_date_time @datetime.data.type@ NOT NULL,
...
CREATE TABLE chunk (
  chunk_id MEDIUMINT UNSIGNED NOT NULL @auto.increment@,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  uber_module_creation_date_time @datetime.data.type@ NOT NULL,
  order_level TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE module_version_consumption (
  module_version_consumption_id BIGINT UNSIGNED NOT NULL @auto.increment@,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  date_time @datetime.data.type@ NOT NULL,
...
CREATE TABLE module_version_contribution (
  module_version_contribution_id INT UNSIGNED NOT NULL @auto.increment@,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
...
CREATE TABLE quality_feedback (
  quality_feedback_id SMALLINT UNSIGNED NOT NULL @auto.increment@,
  en_us_name VARCHAR(100) NOT NULL,
...
CREATE TABLE user_learning_feedback (
  user_learning_feedback_id INT UNSIGNED NOT NULL @auto.increment@,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
...
CREATE TABLE user_quality_feedback (
  user_quality_feedback_id INT UNSIGNED NOT NULL @auto.increment@,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
  date_time @datetime.data.type@ NOT NULL,
...
CREATE TABLE user_module_version_link (
  user_module_version_link_id INT UNSIGNED NOT NULL @auto.increment@,
  user_id INT UNSIGNED NOT NULL,
  module_version_id MEDIUMINT UNSIGNED NOT NULL,
