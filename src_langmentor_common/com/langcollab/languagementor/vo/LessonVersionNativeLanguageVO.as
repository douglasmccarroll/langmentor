...
[RemoteClass(alias="com.langcollab.languagementor.db.LessonVersionNativeLanguageVO")]

public class LessonVersionNativeLanguageVO extends LessonVersionReferencingVO implements IVO {
   ...
   public function LessonVersionNativeLanguageVO() {
      super();
   }

   public function equals(v:IVO):Boolean {
      if (!(v is LessonVersionNativeLanguageVO))
         return false;
   ...
   override public function getClass():Class {
      return LessonVersionNativeLanguageVO;
   }
