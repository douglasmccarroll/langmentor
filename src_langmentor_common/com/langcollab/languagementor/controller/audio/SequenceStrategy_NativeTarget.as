...
public class SequenceStrategy_NativeTarget extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_NativeTarget():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_NativeTarget = new SequenceStrategy_NativeTarget();
