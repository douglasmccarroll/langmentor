...
public class SequenceStrategy_TargetPauseNativeTarget extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_TargetPauseNativeTarget():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_TargetPauseNativeTarget = new SequenceStrategy_TargetPauseNativeTarget();
