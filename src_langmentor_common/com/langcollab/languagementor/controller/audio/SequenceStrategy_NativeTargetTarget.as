...
public class SequenceStrategy_NativeTargetTarget extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_NativeTargetTarget():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_NativeTargetTarget = new SequenceStrategy_NativeTargetTarget();
