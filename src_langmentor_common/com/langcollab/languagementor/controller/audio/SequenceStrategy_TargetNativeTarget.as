...
public class SequenceStrategy_TargetNativeTarget extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_TargetNativeTarget():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_TargetNativeTarget = new SequenceStrategy_TargetNativeTarget();
