...
public class SequenceStrategy_NativeTargetTargetNative extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_NativeTargetTargetNative():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_NativeTargetTargetNative = new SequenceStrategy_NativeTargetTargetNative();
