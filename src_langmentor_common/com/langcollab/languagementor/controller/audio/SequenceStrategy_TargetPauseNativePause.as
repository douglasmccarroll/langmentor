...
public class SequenceStrategy_TargetPauseNativePause extends SequenceStrategy_Chunk implements ISequenceStrategy {
   public function SequenceStrategy_TargetPauseNativePause():void {
   ...
   public function clone():ISequenceStrategy {
      var instance:SequenceStrategy_TargetPauseNativePause = new SequenceStrategy_TargetPauseNativePause();
